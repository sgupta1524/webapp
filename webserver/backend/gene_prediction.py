...
def runGMS2(input_file):
    ...
    command = "perl /projects/VirtualHost/predictc/html/Team3-WebServer/Tools/gms2_linux_64/gms2.pl --seq "+str(input_file)+" --genome-type auto --fnn tool_output/gms2_fasta_result/gms2_fasta_"+str(input_file.split("/")[-1])+" --output tool_output/gms2_gff_result/gms2_gff_"+str(input_file.split("/")[-1].replace(".fasta",""))+" --format gff"
    subprocess.call(command.split())
